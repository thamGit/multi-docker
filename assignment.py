...
welcome = screen.textinput("Welcome to Canteen!",
...
# Food item and cost
    ...
    Order.takeOrder("Yoghurt sticks", 0.50)
    Order.takeOrder("Paddlepop sticks", 2.00)
    Order.takeOrder("Pizza Singles", 1.50)
    Order.takeOrder("Burrito", 3.00)
    Order.takeOrder("Hash Brown", 1.00)
...
def draw_speech(color, x, y):
    ...
    if Order.orderTotal > 0:
        ...
        turtle2.write('Your total is $'+str(Order.orderTotal)+'0',
                      align='center', font=("Arial", 15, 'normal'))
    else:
        turtle2.pencolor('red')
        turtle2.write('Order not placed', align='center',
                      font=("Arial", 15, 'normal'))
    turtle2.goto(320, 35)
    turtle2.pencolor('black')
    turtle2.write('Click on screen to exit', align='center',
